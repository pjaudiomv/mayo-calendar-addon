# Contributing to Mayo Calendar Addon Plugin

## How to Contribute

To contribute to the Mayo Calendar Addon Plugin:

1. Fork the repository
2. Make your changes
3. Send a pull request to the main branch

Take a look at the [issues](https://github.com/bmlt-enabled/mayo-calendar-addon/issues) for bugs that you might be able to help fix.
...
3. Once it's running, log in to the admin panel and activate the "Mayo Calendar Addon" plugin.

4. You can now make edits to the `mayo-calendar-addon.php` file and changes will take effect instantly.
